...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '项目小组', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个项目', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://baidu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '副业搞钱', // 网站关键词 英文逗号隔开
